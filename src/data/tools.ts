...
export const toolCategories: ToolCategory[] = [
  ...
  // ────────────────────────────────────────────
  {
    ...
    tools: [
      ...
      { title: "PDF Merger", description: "Merge multiple PDF files into a single document.", icon: Merge, href: "/tools/pdf-merger", available: true },
      { title: "PDF Splitter", description: "Split a PDF into individual pages or custom ranges.", icon: Scissors, href: "/tools/pdf-splitter", available: true },
      { title: "PDF Compressor", description: "Compress PDF files to reduce size without losing quality.", icon: Archive, href: "/tools/pdf-compressor", available: true },
      { title: "PDF Protector", description: "Add password protection to your PDF documents.", icon: Lock, href: "/tools/pdf-protector", available: true },
      { title: "Unlock PDF", description: "Remove password protection from PDF files.", icon: LockOpen, href: "/tools/unlock-pdf", available: true },
      { title: "PDF Page Extractor", description: "Extract specific pages from a PDF document.", icon: FileOutput, href: "/tools/pdf-page-extractor", available: true },
      { title: "PDF to Image", description: "Convert PDF pages to high-quality PNG or JPEG images.", icon: FileImage, href: "/tools/pdf-to-image", available: true },
      { title: "Image to PDF", description: "Convert images to a single or multi-page PDF document.", icon: FileDown, href: "/tools/image-to-pdf", available: true },
      { title: "PDF Watermark", description: "Add text or image watermarks to PDF documents.", icon: Stamp, href: "/tools/pdf-watermark", available: true },
    ],
  },
  ...
  // ────────────────────────────────────────────
  {
    ...
    tools: [
      { title: "Random Name Generator", description: "Generate random realistic names for characters or testing.", icon: User, href: "/tools/random-name", available: true },
      { title: "Random Username Generator", description: "Generate creative and unique usernames instantly.", icon: AtSign, href: "/tools/random-username", available: true },
      { title: "Random Password Generator", description: "Generate cryptographically secure random passwords.", icon: LockKeyhole, href: "/tools/random-password", available: true },
      { title: "Random Number Generator", description: "Generate random numbers with custom ranges and counts.", icon: Dices, href: "/tools/random-number-generator", available: true },
      { title: "Random Color Generator", description: "Generate random colors in HEX, RGB and HSL formats.", icon: Palette, href: "/tools/random-color", available: true },
      { title: "Random Emoji Generator", description: "Get random emojis for fun or creative inspiration.", icon: SmilePlus, href: "/tools/random-emoji", available: true },
      { title: "Random Team Generator", description: "Split a list of people into random balanced teams.", icon: Users, href: "/tools/random-team", available: true },
      { title: "Dice Roller", description: "Roll virtual dice with custom sides and multiple dice.", icon: Dice1, href: "/tools/dice-roller", available: true },
      { title: "Coin Flip", description: "Flip a virtual coin for quick heads or tails decisions.", icon: CircleDot, href: "/tools/coin-flip", available: true },
      { title: "Fake User Generator", description: "Generate realistic fake user profiles for testing purposes.", icon: UserCheck, href: "/tools/fake-user", available: true },
    ],
  },
  ...
  // ────────────────────────────────────────────
  {
    ...
    tools: [
      { title: "Birthday Countdown", description: "Count down the days until your next birthday celebration.", icon: Cake, href: "/tools/birthday-countdown", available: true },
      { title: "Wedding Countdown", description: "Track the countdown to your special wedding day.", icon: HeartHandshake, href: "/tools/wedding-countdown", available: true },
      { title: "Event Countdown", description: "Create a countdown timer for any upcoming event.", icon: CalendarHeart, href: "/tools/event-countdown", available: true },
      { title: "Exam Countdown", description: "Count down to your exam date to stay motivated.", icon: GraduationCap, href: "/tools/exam-countdown", available: true },
      { title: "New Year Countdown", description: "Watch the countdown to midnight on New Year's Eve.", icon: PartyPopper, href: "/tools/new-year-countdown", available: true },
      { title: "Product Launch Countdown", description: "Build hype with a countdown to your product launch.", icon: Rocket, href: "/tools/product-launch-countdown", available: true },
      { title: "Live Countdown Timer", description: "Create a shareable live countdown timer for any date.", icon: Hourglass, href: "/tools/live-countdown", available: true },
      { title: "Anniversary Countdown", description: "Count down to your wedding or relationship anniversary.", icon: Gift, href: "/tools/anniversary-countdown", available: true },
      { title: "Webinar Countdown", description: "Set up a countdown timer for your upcoming webinar.", icon: Presentation, href: "/tools/webinar-countdown", available: true },
    ],
  },
];
